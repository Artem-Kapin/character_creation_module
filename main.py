...
# Эта версия прошла проверку в тренажере
# Новый импорт.
...
def special(char_name: str, char_class: str) -> str:
    """Функция, описывающая специальные умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция, описывающая тип игрока."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция описывающая выбор персонажа, за которого играть."""
    approve_choice: str = ''
    char_class: str = ''
